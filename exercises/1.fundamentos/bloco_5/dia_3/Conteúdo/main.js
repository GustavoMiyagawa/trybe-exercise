...
function select(e) {
  document.querySelectorAll('.tech')[0].className = '';
...
function changeColor(r) {
  r.target.style.backgroundColor = 'white';
}

divUm.addEventListener('mouseover', changeColor);
divDois.addEventListener('mouseover', changeColor);
